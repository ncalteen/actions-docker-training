...
It is critical to lock your dependencies in your codebase. This allows
Dependabot to parse the currently-installed versions and check for known issues.
This also is a great coding practice as it allows users to be able to build the
...
manager. The following sections will walk you through adding lock files for
several languages.
...
1. Create a branch named `python-deps`
...
1. Create a branch named `node-deps`
...
1. Create a branch named `ruby-deps`
